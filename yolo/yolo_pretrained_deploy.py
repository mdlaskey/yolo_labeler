...
class YOLONet(object):
    ...
    def load_network(self):
        ...
        weights_file = cfg.PRE_TRAINED_DIR+"YOLO_small.ckpt"
        ...
        trained_model_file = cfg.OUTPUT_DIR+ self.file_name
        ...
        self.variables_to_restore = self.variable_to_restore[45:]
